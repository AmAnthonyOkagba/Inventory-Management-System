        ...
        setTimeout(function(){
            switch(window.location.protocol) {
                case 'file:':
                    ...
                    var alertBody = '<div id="ec-direct-run" class="ec-direct-run"><div class="ec-direct-body"><h4>Connection not Strong</h4><p>As we seeing you are try to load site with a week connection. Please try to use strong network. </p></div></div>';
